...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # write to urls.py
        f = open( os.path.join (PROJECT_ROOT+'/shopsys', app, 'urls.py') , 'w')
        f.write(urls)
        f.close()
        ...
        formspath = os.path.join (PROJECT_ROOT+'/shopsys', app, 'forms.py')
        f = open( formspath , 'w')
        ...
        # write to views.py
        viewspath = os.path.join (PROJECT_ROOT+'/shopsys', app, 'views.py')
        f = open( viewspath, 'w')
